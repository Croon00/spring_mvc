...
<body>
	...
	<div class='container' style="margin-top: 20px;">
		...
		<div class='row'>
			...
			<div class='col-sm-6'>
				<form action="product_search_list_pro" method="get" class="form-inline md-form mr-auto mb-4" >
		...
		<div class="card shadow">
			<div class="card-body">
				...
				<table class="table table-hover">
					...
					<tbody>
						<c:forEach var="obj" items="${search_list }">
							<tr>
								...
								<td class="text-center d-none d-md-table-cell"
									style="width: 10%; padding-top:90px">${obj.product_price }</td>
								...
								<td class="text-center d-none d-md-table-cell"
									style="width: 40%">
										 ...
										 <c:if test="${loginAdminBean.check_login == true }">
											...
											<img src="image/cart_del_btn.jpg" style="margin-top: 50px">
											</a>
										</c:if>
