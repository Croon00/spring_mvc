...
<script>
	function check_input() {
		...
		var video_notice_idx = $("#video_notice_idx").val()
		
		console.log(video_notice_idx);
		// 유효성 검사
			...
			<div class="col-sm-6">
				<div class="card shadow">
					<div class="card-body">
						...
						<form action="video_modify_pro" method="post"
							onsubmit="return check_input()">
							
							<input type="hidden" name="video_idx" value="${readVideoBean.video_idx }"/>
							...
							<div class="form-group">
								<label for="video_subject">영상 제목</label> <input type="text"
									...
									value="${readVideoBean.video_subject }" />
							</div>

							<div class="form-group">
								<label for="video_url">영상 URL</label> <input type="text"
									id="video_url" name="video_url" class="form-control"
									value="${readVideoBean.video_url }"  />
							</div>

							<div class="select_list">
							
							<select id= "video_notice_idx" name="video_notice_idx">
									<option>영상 종류</option>
							...
							<div class="form-group">
								<div class="text-right">
									...
									<a href="product_read?product_notice_idx=${readVideoBean.video_notice_idx }&product_idx=${readVideoBean.video_idx}"
