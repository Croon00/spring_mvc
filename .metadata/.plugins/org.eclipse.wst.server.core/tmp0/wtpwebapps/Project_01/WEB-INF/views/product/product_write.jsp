			...
			<div class="col-sm-6">
				<div class="card shadow">
					<div class="card-body">
						...
						<form action="product_write_pro" method="post"
							onsubmit="return check_input()" enctype="multipart/form-data">

							<input type="hidden" name="product_notice_idx" value="${product_board_idx }" /> 
							...
							<div class="form-group">
								<div class="text-right">
									...
									<a href="board_product_list?product_board_idx=${product_board_idx }&page=${now_page}"
