				...
				<div class="card shadow">
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input type="text" id="board_subject" name="board_writer_name" class="form-control" value="제목입니다."/>
						</div>
						
						<div class="form-group">
							<label for="board_content">내용</label>
							<textarea id="board_content" class="form-control"
									  rows="10" style="resize:none">본문입니다.</textarea>
						...
						<div class="form-group">
							...
							<input type="file" name="board_file" id="board_file" class="form-control"
								   accept="image/*"/>
